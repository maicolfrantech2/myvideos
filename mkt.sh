...
msg_info "Getting Mikrotik RouterOS CHR Disk Image"

URL=https://github.com/elseif/MikroTikPatch/releases/download/7.22.2/chr-7.22.2.img.zip
msg_ok "Using fixed version: ${CL}${BL}7.22.2${CL}."
